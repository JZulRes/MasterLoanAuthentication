package io.github.jhipster.masterloanauthentication.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MasterLoanAuthentication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MasterLoanAuthentication");
        ...
        config.getMapConfigs().put("io.github.jhipster.masterloanauthentication.domain.*", initializeDomainMapConfig(jHipsterProperties));
